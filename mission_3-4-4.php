...
<head>
	<meta charset="utf-8">
	<title>mission_3-4-4</title>
</head>
<body>

<?php
  //書き出し用ファイル
  $filename = "mission_3-4-4.txt";
...
<form action="mission_3-4-4.php" method="post">
  <div>
  ...
  <div>
   ...
   <input type="text" name="e_judge" value="<?php if(!empty($edit)){echo $edit;}?>">
    </div>
  <div>
  <div class="button">
